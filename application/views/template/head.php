...
<head>
    ...
    <!--external css-->
    <link href="<?= base_url('assets/'); ?>vendor/lib/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <!-- Custom styles for this template -->
    <link href="<?= base_url('assets/'); ?>vendor/css/style.css" rel="stylesheet">
    <link href="<?= base_url('assets/'); ?>vendor/css/style-responsive.css" rel="stylesheet">
...
<body style="background-image: url('<?= base_url('assets/vendor/img/blog-3.jpg'); ?>'); background-repeat:no-repeat;
